package com.nocode.backend.langgraph4j.demo;
...
public class SimpleGraphApp {
    ...
    public static void main(String[] args) throws GraphStateException {
       ...
       var stateGraph = new StateGraph<>(SimpleState.SCHEMA, initData -> new SimpleState(initData))
        ...
        GraphRepresentation simpleGraph = stateGraph.getGraph(GraphRepresentation.Type.MERMAID, "Simple Graph");
        System.out.println(simpleGraph.content());
