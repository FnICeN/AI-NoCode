...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ...
        long result = appService.addApp(appAddRequest, InnerUserService.getLoginUser(request));
    ...
    public BaseResponse<Boolean> updateApp(@RequestBody AppUpdateRequest appUpdateRequest, HttpServletRequest request) {
        ...
        boolean result = appService.updateApp(appUpdateRequest, InnerUserService.getLoginUser(request));
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Boolean> deleteApp(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        boolean result = appService.deleteApp(deleteRequest.getId(), InnerUserService.getLoginUser(request));
        return ResultUtils.success(result);
    }
    ...
    public BaseResponse<Page<AppVO>> listMyAppVOByPage(@RequestBody AppQueryRequest appQueryRequest, HttpServletRequest request) {
        ...
        Page<AppVO> result = appService.listMyApps(appQueryRequest, InnerUserService.getLoginUser(request));
        return ResultUtils.success(result);
    }
